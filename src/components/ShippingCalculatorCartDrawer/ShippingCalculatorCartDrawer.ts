...
export default class ShippingCalculatorCartDrawer extends HTMLElement {
    private form: HTMLFormElement | null;
    private cepInput: HTMLInputElement | null;
    private submitButton: HTMLButtonElement | null;
    private responseContainer: HTMLElement | null;
    private shippingTitle: HTMLElement | null;
    private shippingForm: HTMLElement;
    ...
    constructor() {
        ...
        this.shippingTitle = this.querySelector('.shipping__title');
        this.shippingForm = this.querySelector('.shipping__form') as HTMLElement;
    ...
    private bindEvents(): void {
        ...
        this.shippingTitle?.addEventListener('click', () => {
            const discountForm = document.querySelector('cart-drawer .discount_coupon__form') as HTMLElement;

            closeDropdown(discountForm);
            toggleDropdown(this.shippingForm)
        });
    }
