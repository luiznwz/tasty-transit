export default class Header extends HTMLElement {
    ...
    constructor() {
        ...
        this.searchBtn = this.querySelector('.header__nav_icons .btn-search') as HTMLElement;
        this.searchInputContainer = this.querySelector('.header__nav_icons .search_input__container') as HTMLElement;

        this.menuDesktop = this.querySelector('.header__desktop_menu') as HTMLElement;
    ...
    initEventListeners() {
        ...
        this.closeMenuMobile.addEventListener('click', () => this.toggleMenuMobile());
        this.mainLinkWithMenu.forEach((element) => {
            element.addEventListener('click', () => this.toggleSubMenu(element.dataset.menu as string, element));
            element.addEventListener('mouseenter', () => this.toggleSubMenu(element.dataset.menu as string, element));
    ...
    toggleSubMenu(dataset: string, element: HTMLElement) {   
        const submenuSelected = this.querySelectorAll(`[data-submenu="${dataset}"]`) as NodeListOf<HTMLElement>;
    ...
    toggleSearchInput() {
        ...
        this.searchBtn.toggleAttribute('open');
    }
}