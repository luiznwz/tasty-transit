...
import { IFetchData, Cart, Product, Collection } from '../types/IFetchData.interface';
...
export default class FetchData implements IFetchData {
    ...
    async addToCart(productId: string, variantId: string, quantity: number = 1): Promise<Cart> {
